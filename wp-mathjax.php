 ...
 * MATHJAX_PLUGIN_DIR           : The absolute path of the wp-mermaid plugin directory.
 * MATHJAX_PLUGIN_URL           : The URL of the wp-mermaid plugin directory.
 * MATHJAX_PLUGIN_PATH          : The absolute path of the wp-mermaid plugin launcher.
 * MATHJAX_PLUGIN_LANGUAGE_PACK : Translation Language pack.
 * MATHJAX_PLUGIN_VERSION       : wp-mermaid plugin version number
 * MATHJAX_PLUGIN_TEXT_DOMAIN   : wp-mermaidplugin text domain
 *
 * Expected values:
 *
 * MATHJAX_PLUGIN_DIR           : {absolute_path}/wp-content/plugins/wp-mermaid/
 * MATHJAX_PLUGIN_URL           : {protocal}://{domain_name}/wp-content/plugins/wp-mermaid/
 * MATHJAX_PLUGIN_PATH          : {absolute_path}/wp-content/plugins/wp-mermaid/wp-mermaid.php
 * MATHJAX_PLUGIN_LANGUAGE_PACK : wp-mermaid/languages
 */
...
define( 'MATHJAX_PLUGIN_TEXT_DOMAIN', 'wp-mermaid' );
